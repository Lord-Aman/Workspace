        ...
        <form>
          <div className="dropdown-container">
            <div className="dropdown-1">
              <select className="dropdown-select" name="Field" id="field" onChange={handleChange}>
                <option className="dropdown-option" value="">Select Field</option>
                {fields.map((val) => (
            ...
            <div className="dropdown-2">
              <select className="dropdown-select" name="Condition" id="condition" onChange={handleChange}>
                <option className="dropdown-option" value="">Select Conditon</option>
                {conditions.map((val) => (
                  <option value={val}>{val}</option>
                ))}
              </select>
            ...
            <div className="dropdown-3">
              <select className="dropdown-select" name="Criteria" id="criteria" onChange={handleChange}>
                <option className="dropdown-option" value="">Select Criteria</option>
                {criterias.map((val) => (
                  <option value={val}>{val}</option>
                ))}
              </select>
